...
//     <button
//       onClick={onClick}
//       className="fixed bottom-6 hover:cursor-pointer right-6 md:w-14 w-12 h-12 md:h-14 bg-gradient-to-r from-[#cf5a16] to-[#e67839] text-white rounded-full shadow-2xl hover:shadow-3xl  flex items-center justify-center z-40 group"
//     >
