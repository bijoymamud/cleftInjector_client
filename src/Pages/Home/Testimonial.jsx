...
export default function Testimonials() {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (newPerPage !== testimonialsPerPage) {
  ...
  }, [testimonials.length, currentIndex, testimonialsPerPage]);
      ...
      <div className="container mx-auto px-4 md:px-0">
        <div className="mb-8 sm:mb-12 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-title">
          ...
          <div className="flex gap-3">
            <button
              ...
              className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 shadow-md ${
                isFirstPage
                  ...
                  : "bg-white hover:bg-orange-500 hover:cursor-pointer hover:scale-110 group"
              }`}
            ...
            <button
              ...
              className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 shadow-md ${
                isLastPage
                  ? "bg-gray-200 cursor-not-allowed opacity-50"
                  : "bg-gradient-to-r from-orange-500 to-orange-600 hover:cursor-pointer hover:from-orange-600 hover:to-orange-700 hover:scale-110"
              }`}
              disabled={isLastPage}
