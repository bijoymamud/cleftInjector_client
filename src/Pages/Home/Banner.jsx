        ...
        <div className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] w-full bg-center bg-cover bg-[url('https://i.ibb.co/7xKZw4pS/banner.png')] rounded-2xl">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4 sm:px-6 md:px-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:space-x-4">
              ...
              <Link to="/get-listed">
                <Button className="inline-flex items-center justify-center gap-2 whitespace-nowrap  h-12 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive hover:bg-primary/90 bg-gradient-to-r hover:cursor-pointer from-[#cf5a16] to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-lg !px-7 !py-5">
