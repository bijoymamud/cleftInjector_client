...
export const ListingStep1 = ({ onSubmit, initialData }) => {
  ...
  useEffect(() => {
    if (initialData?.profile_image) {
      ...
      // Handle the case where the file data might be a simple string (e.g. from initial load if not using Redux Persist)
      // Since we are using Redux, it should be a File object if it was previously uploaded.
    }
  }, [initialData?.profile_image]);
