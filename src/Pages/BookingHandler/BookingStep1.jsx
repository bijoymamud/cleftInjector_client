...
//           <div className="w-10 h-10 bg-orange-500 text-white rounded-md flex items-center justify-center text-sm font-medium">
...
//           <span className="text-base text-gray-900">Sarah Johnson</span>
//         </CardTitle>

//         <div className="flex items-center justify-center gap-8 mt-6">
//           <div className="flex flex-col items-center gap-2">
//             <span className="text-xl font-medium">Date & Time</span>
//             <div className="w-10 h-10 bg-orange-500 text-white rounded-full flex items-center justify-center text-xl font-semibold">
//               1
//             </div>
//           </div>
