...
//           our core values
//         </h1>
//         <p className="text-label text-lg leading-relaxed text-center my-5 w-11/12 md:w-2/5 mx-auto">
...
//         <div className="grid md:grid-cols-3 md:gap-20 gap-5 px-3  md:py-0">
//           {values.map((value) => (
//             <div
//               key={value?.id}
